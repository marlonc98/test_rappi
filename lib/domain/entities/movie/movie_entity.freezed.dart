...
class _$MovieEntityImpl implements _MovieEntity {
  ...
  @override
  String toString() {
    return 'MovieEntity(id: $id, title: $title, overview: $overview, releaseDate: $releaseDate, posterPath: $posterPath, voteAverage: $voteAverage, genrers: $genrers)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, title, overview, releaseDate,
      posterPath, voteAverage, const DeepCollectionEquality().hash(_genrers));
